...
/**
 * Reusable confirm dialog. Used for any destructive action (section/item
 * delete, cancel optimization, etc.).
 */
          ...
          >
            ...
            <div className="flex items-center justify-end gap-2 mt-6">
              ...
              <button
                type="button"
                onClick={onConfirm}
                className={`px-4 py-2 text-[11px] font-mono uppercase tracking-widest rounded-md transition-colors ${confirmBtnClass}`}
              >
                {confirmLabel}
              </button>
            </div>
